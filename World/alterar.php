            ...
            <div class="span10 offset1">
                <div class="card">
                    <div class="card-header">
                        <h3 class="well">Informações da cidade - Alteração</h3>
                    </div>
                </div>
            </div>
            <div class="container">
                <form action="alterar.php" method="POST">
                    ...
                    <input type="hidden" name="hdn_identificador" id="hdn_identificador" value="<?php echo $id ?>"> 
                    Nome
                    <input type="text" name="txt_nome" id="txt_nome" placeholder="Nome da Cidade" value="<?php echo $name ?>"> 
                    <br>
                    ...
                    Distrito
                    <input type="text" name="txt_district" id="txt_district" placeholder="Distrito" value="<?php echo $district ?>"><br>
                    População
                    <input type="text" name="txt_population" id="txt_population" placeholder="População" value="<?php echo $population ?>"><br>
